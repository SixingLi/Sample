...
public:
	...
	bool sendVehicleDriveModeReq(int mainVehicleId, ESimOne_Drive_Mode driveMode);
...
public:
	...
	static bool GenerateRoute_V2(const SSD::SimPoint3DVector& inputPoints, SSD::SimVector<int>& indexOfValidPoints,
