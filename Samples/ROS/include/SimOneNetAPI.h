...
extern "C"
{
	...
	namespace SimOneSM {
		...
		*	Success or not
		*/
		SIMONE_NET_API bool GetV2XInfo(int mainVehicleId, int sensorId, int infoType, SimOne_Data_V2XNFS *pDetections);
		...
		*	Success or not
		*/
		SIMONE_NET_API bool SetV2XInfoUpdateCB(void(*cb)(int mainVehicleId, int sensorId, SimOne_Data_V2XNFS *pDetections));
