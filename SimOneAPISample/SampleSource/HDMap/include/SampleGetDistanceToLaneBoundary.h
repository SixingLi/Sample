...
void SampleGetDistanceToLaneBoundary(const SimPoint3D& pos)
{
	...
	SimOneAPI::SetLogOut(ESimOne_LogLevel_Type::ELogLevelDebug, "[distToLeft, distToRight]: %f, %f", distToLeft, distToRight);
	SimOneAPI::SetLogOut(ESimOne_LogLevel_Type::ELogLevelDebug, "[distToLeft2D, distToRight2D]: %f, %f", distToLeft2D, distToRight2D);
}