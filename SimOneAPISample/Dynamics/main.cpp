/*!
* An sample for SimOneNetAPI based on a DynamicsTest sample (perpendicular parking)
*
* A sample for SimOneNetAPI to test VehicleDynamics module
* 
*@file main.cpp
*/
...
{
	SimOneAPI::SimOneAPIInitialized(0, false);
	while (1)
	{
		auto function = [](int mainVehicleId, const char* event, const char* data) {
			std::cout << "mainVehicleId: " << mainVehicleId << "event: " << event << "data:" << data << std::endl;
		};
