...
#define MAX_DRIVER_NAME_LEN 10
	SIMONE_API bool SimOneAPI::GetV2XInfo(int mainVehicleId, const char* sensorId, int infoType, SimOne_Data_V2XNFS *pDetections) {
	...
	SIMONE_API bool SimOneAPI::SetV2XInfoUpdateCB(void(*cb)(int mainVehicleId, const char* sensorId, SimOne_Data_V2XNFS *pDetections)) {
